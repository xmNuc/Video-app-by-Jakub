  ...
  return (
    <>
      <header className="row fixed-top d-flex align-items-center justify-content-between  flex-wrap">
        <h2 className="logo d-flex justify-content-center col-xl-2 col-md-11 col-sm-11 col-xs-6">
          <a href="/">
        ...
        {actSize <= 800 && (
          <div className="logo d-flex justify-content-end col-md-1 col-sm-1 col-xs-6">
